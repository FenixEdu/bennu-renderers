...
import org.fenixedu.bennu.core.presentationTier.Context;
import org.fenixedu.bennu.core.presentationTier.DefaultContext;
...
public abstract class ContextBaseAction extends BaseAction {
    ...
    public Context createContext(final String contextPathString, HttpServletRequest request) {
        return new DefaultContext(contextPathString);
    }
