 ...
 * 
 * <p>
 * This validator provides a number of methods for validating/converting a <code>String</code> value to a <code>Integer</code>
 * using <code>java.text.NumberFormat</code> to parse either:
 * </p>
 * <ul>
 ...
 * receive a <i>converted</i> <code>Integer</code> value.
 * </p>
 * 
 * <p>
 ...
 * </p>
 * <ul>
 * <li><code>minValue()</code> checks whether the value is greater than or equal to a specified minimum.</li>
 * <li><code>maxValue()</code> checks whether the value is less than or equal to a specified maximum.</li>
 * <li><code>isInRange()</code> checks whether the value is within a specified range of values.</li>
 * </ul>
 * 
 * <p>
...
public class IntegerValidator extends AbstractNumberValidator {
    ...
    /**
     * <p>
     * Validate/convert a <code>Integer</code> using the specified pattern and/ or <code>Locale</code>.
     * 
     * @param value The value validation is being performed on.
     ...
     * @return The parsed <code>Number</code> converted to an <code>Integer</code> if valid or <code>null</code> if invalid.
     */
    @Override
