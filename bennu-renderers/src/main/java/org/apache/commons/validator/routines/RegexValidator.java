 ...
 * <p>
 * Construct the validator either for a single regular expression or a set (array) of regular expressions. By default validation
 * is <i>case sensitive</i> but constructors are provided to allow <i>case in-sensitive</i> validation. For example to create a
 * validator which does <i>case in-sensitive</i> validation for a set of regular expressions:
 * 
 * <pre>
 ...
 * </ul>
 * <p>
 * Cached instances pre-compile and re-use {@link Pattern}(s) - which according to the {@link Pattern} API are safe to use in a
 * multi-threaded environment.
 * 
 * @version $Revision: 595023 $ $Date: 2007-11-14 19:49:23 +0000 (Qua, 14 Nov 2007) $
 * @since Validator 1.4
 */
