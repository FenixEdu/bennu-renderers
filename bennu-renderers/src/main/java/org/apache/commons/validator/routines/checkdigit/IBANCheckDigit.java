 ...
 * <p>
 * The two check digit characters in a IBAN number are the third and fourth characters in the code. For <i>check digit</i>
 * calculation/validation the first four characters are moved to the end of the code. So <code>CCDDnnnnnnn</code> becomes
 * <code>nnnnnnnCCDD</code> (where <code>CC</code> is the country code and <code>DD</code> is the check digit). For check digit
 * calcualtion the check digit value should be set to zero (i.e. <code>CC00nnnnnnn</code> in this example.
 * <p>
 * For further information see <a href="http://en.wikipedia.org/wiki/International_Bank_Account_Number">Wikipedia - IBAN
 * number</a>.
 * 
...
public final class IBANCheckDigit implements CheckDigit, Serializable {
     ...
     * <p>
     * <b>Note:</b> The check digit is the third and fourth characters and and should contain value "<code>00</code>".
     * 
