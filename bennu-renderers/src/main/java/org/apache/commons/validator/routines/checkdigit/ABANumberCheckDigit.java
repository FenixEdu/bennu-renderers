 ...
 * <p>
 * ABA Numbers (or Routing Transit Numbers) are a nine digit numeric code used to identify American financial institutions for
 * things such as checks or deposits (ABA stands for the American Bankers Association).
 * <p>
 * Check digit calculation is based on <i>modulus 10</i> with digits being weighted based on their position (from right to left)
 * as follows:
 * <ul>
 ...
 * </ul>
 * <p>
 * For further information see <a href="http://en.wikipedia.org/wiki/Routing_transit_number">Wikipedia - Routing transit
 * number</a>.
 * 
