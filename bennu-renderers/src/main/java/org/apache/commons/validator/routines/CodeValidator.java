 ...
 * </ul>
 * <p>
 * Configure the validator with the appropriate regular expression, minimum/maximum length and {@link CheckDigit} validator and
 * then call one of the two validation methods provided:
 * </p>
 * <ul>
 ...
 * </ul>
 * <p>
 * Codes often include <i>format</i> characters - such as hyphens - to make them more easily human readable. These can be removed
 * prior to length and check digit validation by specifying them as a <i>non-capturing</i> group in the regular expression (i.e.
 * use the <code>(?:   )</code> notation).
 * 
 * @version $Revision: 591497 $ $Date: 2007-11-02 22:25:16 +0000 (Sex, 02 Nov 2007) $
 * @since Validator 1.4
 */
