 ...
 * <p>
 * This implementation validates/calculates ISBN check digits based on the length of the code passed to it - delegating either to
 * the {@link ISBNCheckDigit#ISBN10_CHECK_DIGIT} or the {@link ISBNCheckDigit#ISBN13_CHECK_DIGIT} routines to perform the actual
 ...
 * ISBN number) which uses the EAN-13 / UPC standard.
 * 
