 ...
 * value. This renderer presents an html menu with two options: one for the
 * <tt>true</tt> value, and other for the <tt>false</tt> value.
 * 
 * <p>
 * The options text is retrieved from the resources using the keys <tt>TRUE</tt>
 * and <tt>FALSE</tt>.
 * 
 * <p>
