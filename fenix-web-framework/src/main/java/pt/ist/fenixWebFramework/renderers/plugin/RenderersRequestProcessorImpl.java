...
public class RenderersRequestProcessorImpl {
    ...
    /**
     * @return the form file associated with the given field name or
	...
	Hashtable<String, UploadedFile> itemsMap = (Hashtable<String, UploadedFile>) request
		.getAttribute(FenixHttpServletRequestWrapper.ITEM_MAP_ATTRIBUTE);
	if (itemsMap == null) {
