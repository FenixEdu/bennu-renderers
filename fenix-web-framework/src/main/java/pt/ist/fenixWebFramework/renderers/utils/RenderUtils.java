...
public class RenderUtils {
     ...
     * the youngest to the oldes we could use
     * <code>"name=asc,dateOfBirth=desc"</code>.
     * 
     * @param criteria
     *            the used criteria
	...
	Map<String, HtmlComponent> map = (Map<String, HtmlComponent>) RenderersRequestProcessorImpl.getCurrentRequest()
		.getAttribute(COMPONENT_REGISTRY_NAME);
