...
public class RendererPropertyUtils {
     ...
     * {@link PropertyUtils#getPropertyType(java.lang.Object, java.lang.String)}
     * were you don't need an instance to get the property.
     * 
     * @return
     */
    ...
    /**
     * Provides an alternative to
     * {@link PropertyUtils#getProperty(java.lang.Object, java.lang.String)}
     * that throws an exception for properties like <code>a.b</code> if the
     * <code>a</code> is a null value. This method allows you to choose if the
     * value for <code>a</code> is created or if the method simply returns
     * <code>null</code>. Any exception thrown by {@link PropertyUtils} is
    ...
    /**
     * Provides an alternative to
     * {@link PropertyUtils#setProperty(java.lang.Object, java.lang.String, java.lang.Object)}
     * that throws an exception for properties like <code>a.b</code> if the
     * <code>a</code> is a null value. This method allows you to choose if the
     * value for <code>a</code> is created or if the method simply returns
     * without setting the value. Any exception thrown by {@link PropertyUtils}
