 ...
 * <p>
 * Check digit calculation is based on <i>modulus 11</i> with digits being weighted based by their position, from right to left
 * with the first digit being weighted 1, the second 2 and so on. If the check digit is calculated as "10" it is converted to "X".
 * <p>
 * <b>N.B.</b> From 1st January 2007 the book industry will start to use a new 13 digit ISBN number (rather than this 10 digit
 * ISBN number) which uses the EAN-13 / UPC (see {@link EAN13CheckDigit}) standard.
 * <p>
