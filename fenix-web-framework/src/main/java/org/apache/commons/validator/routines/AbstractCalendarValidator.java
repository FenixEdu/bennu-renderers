 ...
 * 
 * <p>
 * This is a <i>base</i> class for building Date / Time Validators using format parsing.
 * </p>
 * 
 * @version $Revision: 594917 $ $Date: 2007-11-14 15:36:40 +0000 (Qua, 14 Nov 2007) $
...
public abstract class AbstractCalendarValidator extends AbstractFormatValidator {
     ...
     * </p>
     * 
     * @param pattern The pattern used to validate the value against or <code>null</code> to use the default for the
     *            <code>Locale</code>.
     ...
     * @param field The field <i>level</i> to compare to - e.g. specifying <code>Calendar.MONTH</code> will compare the year and
     *            month
    ...
    protected int compare(Calendar value, Calendar compare, int field) {
        ...
        if (result != 0
                || (field == Calendar.DATE || field == Calendar.DAY_OF_MONTH || field == Calendar.DAY_OF_WEEK || field == Calendar.DAY_OF_WEEK_IN_MONTH)) {
            return result;
        }
     ...
     * @param value The Calendar value.
     * @param compare The <code>Calendar</code> to check the value against.
     * @param field The field <i>level</i> to compare to - e.g. specifying <code>Calendar.MINUTE</code> will compare the hours and
     *            minutes
     *            portions of the calendar.
     * @return Zero if the first value is equal to the second, -1
     *         if it is less than the second or +1 if it is greater than the second.
    ...
    /**
     * <p>
     * Compares a calendar's quarter value to another, indicating whether it is equal, less then or more than the specified
     * quarter.
     * </p>
     * 
     * @param value The Calendar value.
    ...
    /**
     * <p>
     * Compares the field from two calendars indicating whether the field for the first calendar is equal to, less than or greater
     * than the field from the second calendar.
     * 
     * @param value The Calendar value.
     * @param compare The <code>Calendar</code> to check the value against.
