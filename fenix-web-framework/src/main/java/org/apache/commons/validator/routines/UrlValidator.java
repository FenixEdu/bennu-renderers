 ...
 * </p>
 * Behavior of validation is modified by passing in options: <li>ALLOW_2_SLASHES - [FALSE] Allows double '/' characters in the
 * path component.</li> <li>NO_FRAGMENT- [FALSE] By default fragments are allowed, if this option is included then fragments are
 * flagged as illegal.</li> <li>ALLOW_ALL_SCHEMES - [FALSE] By default only http, https, and ftp are considered valid schemes.
 * Enabling this option will let any scheme pass validation.</li>
 * 
 * <p>
 * Originally based in on php script by Debbie Dyer, validation.php v1.2b, Date: 03/07/02, http://javascript.internet.com.
 ...
 *      </a>
 * 
 * @version $Revision: 595020 $ $Date: 2007-11-14 19:36:45 +0000 (Qua, 14 Nov 2007) $
 * @since Validator 1.4
 */
