 ...
 * <p>
 * This implementation only handles <i>numeric</i> codes, such as <b>EAN-13</b>. For <i>alphanumeric</i> codes such as
 * <b>EAN-128</b> you will need to implement/override the <code>toInt()</code> and <code>toChar()</code> methods.
 * <p>
 * 
 * @version $Revision: 909004 $ $Date: 2010-02-11 14:44:57 +0000 (Qui, 11 Fev 2010) $
 * @since Validator 1.4
 */
public abstract class ModulusCheckDigit implements CheckDigit, Serializable {
     ...
     * <p>
     * Some modulus routines weight the value of a character depending on its position in the code (e.g. ISBN-10), while others
     * use different weighting factors for odd/even positions (e.g. EAN or Luhn). Implement the appropriate mechanism required by
     ...
     * <p>
     * <b>Note:</b> this implementation only handlers numeric values For non-numeric characters, override this method to provide
     ...
     * <p>
     * <b>Note:</b> this implementation only handles numeric values For non-numeric characters, override this method to provide
