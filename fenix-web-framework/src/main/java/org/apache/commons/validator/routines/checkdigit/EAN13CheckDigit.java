 ...
 * <p>
 * Check digit calculation is based on <i>modulus 10</i> with digits in an <i>odd</i> position (from right to left) being weighted
 * 1 and <i>even</i> position digits being weighted 3.
 * <p>
 * For further information see:
 * <ul>
 * <li>EAN-13 - see <a href="http://en.wikipedia.org/wiki/European_Article_Number">Wikipedia - European Article Number</a>.</li>
 * <li>UPC - see <a href="http://en.wikipedia.org/wiki/Universal_Product_Code">Wikipedia - Universal Product Code</a>.</li>
 * <li>ISBN-13 - see <a href="http://en.wikipedia.org/wiki/ISBN">Wikipedia - International Standard Book Number (ISBN)</a>.</li>
 * </ul>
 * 
