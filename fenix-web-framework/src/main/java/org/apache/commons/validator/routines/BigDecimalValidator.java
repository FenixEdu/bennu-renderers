 ...
 * 
 * <p>
 * This validator provides a number of methods for validating/converting a <code>String</code> value to a <code>BigDecimal</code>
 ...
 * receive a <i>converted</i> <code>BigDecimal</code> value.
 * </p>
 * 
 * <p>
...
public class BigDecimalValidator extends AbstractNumberValidator {
    ...
    /**
     * <p>
     * Validate/convert a <code>BigDecimal</code> using the specified pattern and/ or <code>Locale</code>.
     * 
     * @param value The value validation is being performed on.
     * @param pattern The pattern used to validate the value against, or the
     *            default for the <code>Locale</code> if <code>null</code>.
