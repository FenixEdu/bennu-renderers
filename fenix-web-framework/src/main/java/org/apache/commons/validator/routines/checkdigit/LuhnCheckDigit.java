 ...
 * <li><a href="http://en.wikipedia.org/wiki/IMEI">IMEI Numbers</a> - International Mobile Equipment Identity Numbers</li>
 * </ul>
 * Check digit calculation is based on <i>modulus 10</i> with digits in an <i>odd</i> position (from right to left) being weighted
 * 1 and <i>even</i> position digits being weighted 2 (weighted values greater than 9 have 9 subtracted).
 * <p>
 * See <a href="http://en.wikipedia.org/wiki/Luhn_algorithm">Wikipedia</a> for more details.
 * 
