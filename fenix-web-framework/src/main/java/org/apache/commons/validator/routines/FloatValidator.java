 ...
 * 
 * <p>
 * This validator provides a number of methods for validating/converting a <code>String</code> value to a <code>Float</code> using
 * <code>java.text.NumberFormat</code> to parse either:
 * </p>
 * <ul>
 ...
 * receive a <i>converted</i> <code>Float</code> value.
 * </p>
 * 
 * <p>
...
public class FloatValidator extends AbstractNumberValidator {
     ...
     * @return The parsed <code>Number</code> converted to a <code>Float</code> if valid or <code>null</code> if invalid.
     */
    @Override
